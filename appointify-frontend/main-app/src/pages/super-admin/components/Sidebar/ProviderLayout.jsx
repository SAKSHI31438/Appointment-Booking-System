...
const ProviderLayout = () => {
  ...
  return (
    <div>
      ...
      {nav && (
        <div className="flex lg:hidden h-screen w-[80%] bg-[#540863] fixed z-[999] top-0 left-0 transform transition-all duration-500 ease-in-out">
          <div className="flex flex-col text-white w-full h-full space-y-4">
            ...
            <div className="p-6 text-2xl font-bold border-b border-white/20">
              <Link to="/admin/home">Super Admin</Link>
            </div>
