        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black">
              <li>
                <Link to={"/services"} className="hover:text-[#540863]">
                  Book Appointment
                </Link>
              </li>
              <li>
                <Link to={"/"} className="hover:text-[#540863]">
                  Categories
                </Link>
              </li>
              <li>
                <Link to={"/myBookings"} className="hover:text-[#540863]">
                  My Appointments
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black">
              <li>
                <Link to="/about" className="hover:text-[#540863]">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover:text-[#540863]">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black">
              ...
              <li>
                <Link to="/faq" className="hover:text-[#540863]">
                  FAQs
                </Link>
              </li>
            </ul>
